...
import { OfflineOffersService } from './offline-offers.service';

@Component({
  selector: 'offline-offers',
  templateUrl: './offline-offers.component.html',
  styleUrls: ['./offline-offers.component.scss'],
  animations: fuseAnimations,
})
export class OfflineOffersComponent implements OnInit {
   ...
   */
  constructor(
    private _apiService: OfflineOffersService,
